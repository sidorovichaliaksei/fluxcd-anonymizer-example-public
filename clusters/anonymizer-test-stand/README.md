...
> ⚠️ `public` в названии бакета не означает доступ без авторизации из интернета — это лишь про то, что с бакетом работают ещё и микросервисы Mindbox (по подписанным ссылкам). Про термины `public` / `private` и требования к доступу — см. [корневой README](../../README.md#3-s3-хранилище).
